...
function EnterpriseInfoCard({data}) {
    ...
    return (
        ...
        <div style={{ padding: '60px', width: '70%', height: '280px', backgroundColor: '', borderRadius: '10px', boxShadow: '0 4px 8px 0 rgba(0, 0, 0, 0.2), 0 6px 20px 0 rgba(0, 0, 0, 0.19)' }}>
            ...
            <div style={{ backgroundColor: 'red', width: '300px', height: '200px', margin: 'auto', display: 'flex', flexDirection: 'column', justifyContent: 'center', paddingTop: '20px' }}>
